...
% Wind Type
settings.hwm = false;        %Set to true to use HWM wind model
%otherwise the wind model will be the one described in "windgen.m"

% Wind is randomly generated but constant during the simulation. 
...
settings.stoch.parallel = false; % Set to true to use parallel simulation
