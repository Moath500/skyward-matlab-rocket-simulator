...
settings.OMEGAmin = 75*pi/180;        %[rad] Minimum Elevation Angle, user input in degrees (ex. 80)
settings.OMEGAmax = 75*pi/180;        %[rad] Maximum Elevation Angle, user input in degrees (ex. 80)
