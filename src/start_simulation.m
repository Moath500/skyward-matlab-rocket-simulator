...
global t_plot T_plot alpha_plot beta_plot M_plot CA_plot Drag_plot;
% global Forces_plot;
% global WIND alt;
...
xlabel('time [sec]'), ylabel('pitch rate p [grad/sec]')
subplot(3,1,2)
plot(Ta, Ya(:, 9)*180/pi), grid on;
xlabel('time [sec]'), ylabel('yaw rate p [grad/sec]')
subplot(3,1,3)
plot(Ta, Ya(:, 7)*180/pi), grid on;
xlabel('time [sec]'), ylabel('roll rate q [grad/sec]')
