...
%Total Time
Tf = [Ta; Ta(end)+Td1; Ta(end)+Td1(end)+Td2;Ta(end)+Td1(end)+Td2(end)+Tm];

%Parachute State
Yp = [Yd1;Yd2;Ym];
Tp = [Ta(end)+Td1;Ta(end)+Td1(end)+Td2;Ta(end)+Td1(end)+Td2(end)+Tm];
...
%         'MarkerFaceColor','k');
%     legend([h1 h2 h3],'Apogee/Drogue1 Deployment','Drogue 2 Deployment', ...
