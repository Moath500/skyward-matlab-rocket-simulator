...
settings.wind.AzMin = (179)*pi/180;           % [rad] Minimum Azimuth, user input in degrees (ex. 90)
settings.wind.AzMax = (181)*pi/180;           % [rad] Maximum Azimuth, user input in degrees (ex. 90)
